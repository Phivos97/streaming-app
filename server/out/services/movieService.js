...
const fetchGenres = async () => {
    ...
    if (!movieGenres || !tvGenres || !genres) {
        ...
        genres = [...movieGenresResponse.data.genres, tvGenresResponse.data.genres].flat().filter((currentGenre, index, allGenres) => index === allGenres.findIndex((genre) => genre.id === currentGenre.id));
